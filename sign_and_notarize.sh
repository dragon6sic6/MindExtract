...
DMG_NAME="MindExtract-2.1.2-Universal"
...
# Sign the embedded Python framework as a bundle (its symlink structure is
# restored in the source tree, so codesign can identify it as a framework)
